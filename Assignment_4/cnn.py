    ...
    def set_training_flag(self,layer_numbers=[],layer_names="",trainable_flag=True):
        ...
        if layer_number!=None:
          for i in layer_number:
            self.model.layer[layer_number-1]=trainable
        else:
    ...
    def get_weights_without_biases(self,layer_number=None,layer_name=""):
        ...
        if layer_number==None:
          # CHECK
            ...
            # layer_number = self.model.layers.index(layer)
...
#                return None
    ...
    def load_a_model(self,model_name="",model_file_name=""):
        ...
        if model_name=="VGG16":
            ...
            new_model = keras.applications.VGG19()
        if new_model:
            self.layers=[]
            self.model = keras.Sequential()
            ...
            #     self.layers.append(layer_name.name)
        else:
    ...
    def train(self, X_train, y_train, batch_size, num_epochs):
        ...
        self.accuracies=history.history["acc"]
        # print(history)
